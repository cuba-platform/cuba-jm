...
public class JMTestContainer extends TestContainer {

    public JMTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/addon/jm/app.properties",
    ...
    public static class Common extends JMTestContainer {

        public static final JMTestContainer.Common INSTANCE = new JMTestContainer.Common();
