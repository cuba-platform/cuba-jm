...
public class JmcomponentTestContainer extends TestContainer {

    public JmcomponentTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/jmcomponent/app.properties",
    ...
    public static class Common extends JmcomponentTestContainer {

        public static final JmcomponentTestContainer.Common INSTANCE = new JmcomponentTestContainer.Common();
