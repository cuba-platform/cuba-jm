...
@WebListener
public class DefaultWebFilterCreator implements ServletContextListener {
    @Override
    public void contextInitialized(ServletContextEvent sce) {
        ServletContext servletContext = sce.getServletContext();
        FilterRegistration.Dynamic javamelody = servletContext.addFilter("javamelody-web", MonitoringFilter.class);
